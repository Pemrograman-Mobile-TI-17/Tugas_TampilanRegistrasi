...
public class ActivityDataLaptop extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_data_handphone);
        ...
        newsList.clear();
        adapter = new AdapterLaptop(ActivityDataLaptop.this, newsList);
    ...
    public void onBackPressed() {
        Intent i = new Intent(ActivityDataLaptop.this, HomeAdminActivity.class);
        startActivity(i);
        finish();
    }
                        ...
                        try {
                            ...
                            if (status == false) {
                                ...
                                for (int i = 0; i < jsonArray.length(); i++) {
                                    ...
                                    final String kodeHandphone = jsonObject.getString("kodeLaptop");
                                    final String merkHandphone = jsonObject.getString("merkLaptop");
                                    final String tipeHandphone = jsonObject.getString("tipeLaptop");
                                    final String spesifikasi = jsonObject.getString("spesifikasi");
                                    final String hargaHandphone = jsonObject.getString("hargaLaptop");
                                    ...
                                    handphone.setLaptop(spesifikasi);
                                    ...
                                    list.setOnItemClickListener(new AdapterView.OnItemClickListener() {
                                        ...
                                        public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                                            ...
                                            Intent a = new Intent(ActivityDataLaptop.this, EditLaptopDanHapusActivity.class);
